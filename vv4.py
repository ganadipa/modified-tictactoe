...
def stringState(state, req = None):
    word = ''
    for i in state:
        for j in i:
...
if __name__ == '__main__':
    ...
    with open('vv3_minimax_helper.csv', 'r') as file:
        ...
        for state, score in reader: 
            ...
            for hehe in possibleState(realState(state)):
                minimax_helper[stringState(hehe)] = float(score)

    with open('vv3_database.csv', 'r') as file:
        reader = csv.reader(file, delimiter=';')
        for state, bmove in reader: 
            database[state] = tuple_from_string(bmove)
            
    printBoard([[x,e,e,e,e],
                        [e,e,o,e,e],
                        [e,e,x,e,e],
                        [e,e,e,e,e],
                        [e,e,e,e,e]])
    print(stringState([[x,e,e,e,e],
                        [e,e,o,e,e],
                        [e,e,x,e,e],
                        [e,e,e,e,e],
                        [e,e,e,e,e]
                        ]), 'more')
    print(minimax_helper[stringState([[x,e,e,e,e],
                        [e,e,o,e,e],
                        [e,e,x,e,e],
                        [e,e,e,e,e],
                        [e,e,e,e,e]]
    ...
    print(minimax_helper[stringState([[e,e,e,e,x],
                        [e,e,e,e,e],
                        [e,e,x,o,e],
                        [e,e,e,e,e],
                        [e,e,e,e,e]]
